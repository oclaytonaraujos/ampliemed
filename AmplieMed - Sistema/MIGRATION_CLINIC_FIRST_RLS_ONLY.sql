-- ═════════════════════════════════════════════════════════════════════════════
-- 🏥 AMPLIEMED - MIGRAÇÃO RLS POLICIES E HELPER FUNCTIONS
-- 
-- Este arquivo SEGURO contém APENAS RLS Policies e Helper Functions
-- Não tenta adicionar constraints (já existem no schema)
-- Pode ser executado múltiplas vezes com segurança
-- 
-- ⚠️  INSTRUÇÕES:
-- 1. Abra o SQL Editor do Supabase Dashboard
-- 2. Cole APENAS o conteúdo deste arquivo
-- 3. Clique em "RUN" (botão verde no canto superior)
-- 4. Aguarde a conclusão (~1-2 minutos)
-- 
-- ═════════════════════════════════════════════════════════════════════════════
...
-- ═════════════════════════════════════════════════════════════════════════════
-- 4. ATUALIZAR RLS: patients (isolamento por clinic_id)
-- ═════════════════════════════════════════════════════════════════════════════
...
-- ═════════════════════════════════════════════════════════════════════════════
-- 10. FUNÇÕES HELPER (idempotentes - com DROP FUNCTION IF EXISTS)
-- ═════════════════════════════════════════════════════════════════════════════
...
-- 
-- 2. O frontend (Login.tsx, ClinicSignup.tsx, AppContext.tsx) já está pronto!
-- 
-- ═════════════════════════════════════════════════════════════════════════════
