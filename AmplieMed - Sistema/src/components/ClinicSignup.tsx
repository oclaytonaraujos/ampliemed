  ...
  return (
    <div className="space-y-4">
      ...
      {currentStep === 'confirmation' && (
        <div className="space-y-4">
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 text-xs space-y-2">
            <strong className="text-blue-900">Resumo do seu registro:</strong>
            <div className="text-blue-800 space-y-1 ml-2">
          ...
          <div className="space-y-3">
            <label className="flex items-start gap-3 cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
              <input
                ...
                disabled={loading}
                className="w-4 h-4 mt-0.5 border border-gray-200 rounded focus:ring-2 focus:ring-blue-500"
              />
              <span className="text-xs text-gray-700">
                Aceito os <a href="#" className="text-blue-600 hover:underline font-medium">termos de serviço</a> e <a href="#" className="text-blue-600 hover:underline font-medium">política de privacidade</a> <span className="text-red-400">*</span>
              </span>
            </label>
            ...
            <label className="flex items-start gap-3 cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
              ...
              />
              <span className="text-xs text-gray-700">
                Entendo minhas responsabilidades com a <a href="#" className="text-blue-600 hover:underline font-medium">Lei LGPD</a> e proteção de dados de pacientes <span className="text-red-400">*</span>
              </span>
            </label>
          </div>
